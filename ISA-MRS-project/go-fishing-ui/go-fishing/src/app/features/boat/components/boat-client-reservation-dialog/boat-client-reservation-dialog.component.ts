...
@Component({
  selector: 'app-boat-client-reservation-dialog',
  templateUrl: './boat-client-reservation-dialog.component.html',
  styleUrls: ['./boat-client-reservation-dialog.component.css'],
})
export class BoatClientReservationDialogComponent implements OnInit {
  ...
  totalPrice: number = 0;
  constructor(
    public dialogRef: MatDialogRef<BoatClientReservationDialogComponent>,
