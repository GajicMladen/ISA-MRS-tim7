...
@Component({
  selector: 'app-cottage-client-reservation-dialog',
  templateUrl: './cottage-client-reservation-dialog.component.html',
  styleUrls: ['./cottage-client-reservation-dialog.component.css'],
})
export class CottageClientReservationDialogComponent implements OnInit {
